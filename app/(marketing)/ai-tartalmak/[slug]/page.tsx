        ...
        <div className="mt-12 border-t border-[rgba(255,255,255,0.06)] pt-8">
          ...
          <div className="flex flex-wrap gap-3">
            {[
              {
                label: "Facebook",
                href: `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(`${siteConfig.url}/ai-tartalmak/${article.slug}`)}`,
                icon: (
                  <svg fill="currentColor" height={16} viewBox="0 0 24 24" width={16} aria-hidden>
              ...
              {
                label: "LinkedIn",
                href: `https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(`${siteConfig.url}/ai-tartalmak/${article.slug}`)}`,
                icon: (
                  <svg fill="currentColor" height={16} viewBox="0 0 24 24" width={16} aria-hidden>
              ...
              {
                label: "X",
                href: `https://twitter.com/intent/tweet?url=${encodeURIComponent(`${siteConfig.url}/ai-tartalmak/${article.slug}`)}&text=${encodeURIComponent(article.title)}`,
                icon: (
                  <svg fill="currentColor" height={15} viewBox="0 0 24 24" width={15} aria-hidden>
              ...
              {
                label: "Telegram",
                href: `https://t.me/share/url?url=${encodeURIComponent(`${siteConfig.url}/ai-tartalmak/${article.slug}`)}&text=${encodeURIComponent(article.title)}`,
                icon: (
                  <svg fill="currentColor" height={16} viewBox="0 0 24 24" width={16} aria-hidden>
